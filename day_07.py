...
def set_sequence(data, settings, feedback):
    prev = 0
...
if __name__ == "__main__":
    ...
    print("Part One:", max(set_sequence(data_set, permutation, False) for permutation in one))
    print("Part Two:", max(set_sequence(data_set, permutation, True) for permutation in two))
